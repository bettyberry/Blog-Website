...
Share your recipes and stories with us!</p>
        </div>
      </section>

      {/* Feature Cards - Food Categories */}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <form className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            <input 
              ...
              className="flex-grow px- py-2 text-lg rounded-lg bg-white text-slate-900 shadow-md border border-slate-300 focus:outline-none focus:ring-2 focus:ring-slate-400 placeholder-slate-500"
              required
            />
            <button 
              type="submit" 
